...
const ProjectSelect = ({ selectedAddress, setSelectedProject, open, handleClose, selectedCustomer }) => {
    ...
    >
        <Box sx={style}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <Typography sx={{ textAlign: "center", p: 0.2, fontSize: '18px', fontWeight: 700 }}>{steps === 0 ? 'Select an Project' : steps === 1 ? 'Create an Address' : ''}</Typography>
