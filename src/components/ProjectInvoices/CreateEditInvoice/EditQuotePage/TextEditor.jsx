      ...
      <Box>
        ...
        >
          ...
          <select
            ...
            value={formats.size ? parseInt(formats.size.replace("px", "")) : 16}
            style={{
              paddingLeft: 10,
              paddingRight: 10,
              paddingTop: 5,
          ...
          <select
            ...
            value={typeof formats.font === "string" ? formats.font : "default"}
            style={{
              paddingLeft: 10,
              paddingRight: 10,
              paddingTop: 5,
          ...
          <button type="button" onClick={() => toggleList("ordered")}>
            <FormatListNumbered icon="ri:list-ordered" width="24" height="24" />
          </button>
          {/* Text Color */}
          <input
            type="color"
