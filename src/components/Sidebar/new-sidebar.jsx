            ...
            >
              ...
              <AccordionDetails style={{ padding: "10px" }}>
                <NavLink to="/mirrors/hardwares">
                  <Box
                    className={`button-item ${
                      location.pathname === "/mirrors/hardwares" ? "active" : ""
                    }`}
                  >
                ...
                <NavLink to="/mirrors/glass-addons">
                  <Box
                    className={`button-item ${
                      location.pathname === "/mirrors/glass-addons"
                        ? "active"
                        : ""
                    }`}
                  >
                ...
                <NavLink to="/mirrors/edge-works">
                  <Box
                    className={`button-item ${
                      location.pathname === "/mirrors/edge-works"
                        ? "active"
                        : ""
                    }`}
                  >
                ...
                <NavLink to="/mirrors/glass-types">
                  <Box
                    className={`button-item ${
                      location.pathname === "/mirrors/glass-types"
                        ? "active"
                        : ""
                    }`}
                  >
