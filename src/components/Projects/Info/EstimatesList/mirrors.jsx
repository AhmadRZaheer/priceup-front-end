...
const MirrorEstimatesList = ({ projectId }) => {
    ...
    } = useFetchAllDocuments(`${routePrefix}/by-project/${projectId}?page=${page}&limit=${itemsPerPage}&search=${search}&category=${EstimateCategory.MIRRORS}`);
    const {
