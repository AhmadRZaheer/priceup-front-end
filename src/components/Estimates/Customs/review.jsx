...
import {
  generateEstimatePayloadForCustom,
...
export const CustomReview = ({ setStep , listData }) => {
  ...
  const handleEditEstimate = () => {
    const estimateConfig = generateEstimatePayloadForCustom(
      currentQuoteState,
      measurements,
      selectedContent,
  ...
  const handleEstimateSubmit = () => {
    ...
    if (allGoodStatus) {
      if ([quoteState.CREATE, quoteState.CUSTOM].includes(currentQuoteState)) {
        ...
        console.log(estimateConfig,'estimateConfigestimateConfig')
            ...
            >
              {summaryState || windowWidth > 600 ? (
                ...
                >
                  ...
                  {/* {layoutId !== EstimateCategory.SHOWERS && (
                    <Box
                      sx={{
                        display: "flex",
                        alignItems: "center",
