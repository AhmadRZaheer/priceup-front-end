...
export const SimpleLayoutDimensions = () => {
    ...
    console.log(doorWidthFromredux > showerSettings?.doorWidth || doorWidthFromredux < 1, 'state', doorWidthFromredux, showerSettings?.doorWidth)
    return (
        <>
            <Box
                sx={{
            ...
            >
                ...
                >
                    <div style={{ width: "100%" }}>
                        ...
                        >
                            <NavLink to={currentQuoteState === quoteState.EDIT ? "/estimates" : "/estimates/layouts"}>
                                <Box
                                    // onClick={() => {
                            ...
                            >
                                ...
                                >
                                    ...
                                    <>
                                        ...
                                        {(doorWidthFromredux > showerSettings?.doorWidth || doorWidthFromredux < 1) ?
                                            <Box sx={{ display: 'flex', flexWrap: 'nowrap', gap: '10px', alignItems: 'flex-start' }}>
                                                <InfoOutlinedIcon fontSize="small" sx={{ mt: '5px' }} />
                                                <Typography sx={{ fontSize: "15px" }}>
                                                    Door width must be in range between 1 - {showerSettings?.doorWidth}. Max door width can be customized in company settings.
                                                </Typography>
                                            </Box> : ""}
                                    </>
                                </Box>
                                ...
                                >
                                    ...
                                    <Box sx={{ width: "150px" }}>
                                        <Button
                                            ...
                                            fullWidth
                                            disabled={
                                                !dynamicFieldAllocationEqualToLayoutCount || !allAllocatedFieldsPopulated || (doorWidthFromredux > showerSettings?.doorWidth || doorWidthFromredux < 1)
                                            }
                                            sx={{
                                                height: 40,
                                                fontSize: 20,
