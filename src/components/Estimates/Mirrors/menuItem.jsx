...
const MenuItem = ({
  ...
  const activeFinishOrThickness = type === mirrorHardwareTypes.GLASSTYPE ? selectedContent.glassType.thickness : type === mirrorHardwareTypes.EDGEWORK ? selectedContent.edgeWork.thickness : null;
    ...
    <Tooltip
      title={
        <h3 style={{ color: "white" }}>
          This {type} is not availabe{[mirrorHardwareTypes.GLASSTYPE, mirrorHardwareTypes.EDGEWORK].includes(type) ? ' in current selected thickness' : ''}.
        </h3>
      }
      sx={{ fontSize: "20px" }}
      open={showToolTip}
