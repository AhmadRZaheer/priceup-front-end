...
import { getEstimateMeasurements, getNotifications, getProjectId, getSelectedContent, getSelectedItem, initializeStateForEditQuote, setEstimateMeasurements, setMultipleNotifications, setSandBlasting, setSqftArea } from "@/redux/mirrorsEstimateSlice";
            ...
            <form>
                ...
                >
                    ...
                    >
                        ...
                        >
                            <NavLink to={currentEstimateState === quoteState.EDIT ? (projectId ? `/projects/${projectId}` : "/estimates") : `/projects/${projectId}`}>
                                <Button
                                    sx={{
                                        width: { xs: 120, sm: 180 },
                                        color: "black",
