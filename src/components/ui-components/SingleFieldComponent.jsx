...
export const SingleField = ({ item, index, estimateState, addedFields, handleModify }) => {
    ...
    const [isEditField, setisEditField] = useState(
        estimateState === quoteState.EDIT && item.label ? true : false
    );
