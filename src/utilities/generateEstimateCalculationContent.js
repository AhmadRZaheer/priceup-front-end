...
export const generateContentForShowerEdit = (listData, estimate) => {
  console.log(listData,'listDatalistDatalistDatalistDatalistData1',estimate)
  ...
  console.log(glassTypee,'glassTypeeglassTypee',listData?.glassType,estimate?.config?.glassType?.type)
  let glassAddons = [];
...
// export const generateContentForCustomEdit = (hardwaresList, estimate) => {
//   let calculateChannelWarning = {
//     status: false,
//     variant: notificationsVariant.DEFAULT,
//     message: "",
...
export const generateEstimatePayloadForCustom = (
  estimateState,
  measurements,
  selectedContent,
  layout_id,
